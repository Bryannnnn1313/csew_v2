...
v207 = Vuln("XXX", "", "Has clamav freshclam been run?(Moved to 314)",
            False)
v208 = Vuln("minPassAge", "", "Value of min password age to score is 30 in Local Password Policies", False)
v209 = Vuln("maxPassAge", "", "Value of max password age to score is 60 in Local Password Policies", False)
v210 = Vuln("maxLoginTries", "", "Value of max login retries to score is 5 in Account Lockout Policies", False)
v211 = Vuln("checkPassLength", "", "Value min pw length is 10 in Local Password Policies", False)
v212 = Vuln("checkPassHist", "", "Value of passwords to remember is 5 in Local Password Policies", False)
v213 = Vuln("checkPassCompx", "", "Has password complexity been implemented in Local Password Policies?", False)
...
vulnDict = {"Desktop": '', "silentMiss": {'enable': False}, "FTPServer": {'enable': False},"disableGuest": {'points': [], 'enable': False}, "disableAdmin": {'points': [], 'enable': False}, "requireCTRL_ALT_DEL": {'points': [], 'enable': False}, "XXX": {'points': [], 'enable': False}, "checkFirewall": {'points': [], 'enable': False},
            "XXX": {'points': [], 'enable': False}, "avUpdated": {'points': [], 'enable': False}, "minPassAge": {'points': [], 'enable': False}, "maxPassAge": {'points': [], 'enable': False}, "maxLoginTries": {'points': [], 'enable': False}, "checkPassLength": {'points': [], 'enable': False}, "checkPassHist": {'points': [], 'enable': False},
...
def submitCallback():
    ...
    if errorFree:
        ...
        installer.command = 'pyinstaller -y -F -w --add-data ' + '"' + balloonPath + '"' + ';"." ' + '"' + scoringPath + '"'
...
Checkbutton(frame, text="Check if this configurator is on the Desktop of the main account.", variable=userLoc).grid(
    row=0, column=2, sticky=W, columnspan=4)
...
Label(frame, text="Enter the user name where\nyou want the information to goto.").grid(row=1, column=4, columnspan=2,
                                                                                       sticky=W)
...
Label(frame3, text="Explanation (Add a space in between entries)", font=('Verdana', 10, 'bold')).grid(row=0, column=4,
                                                                                                      sticky=W)
# Frame4 Interface
...
Label(frame4, text="Explanation (Add a space in between entries)", font=('Verdana', 10, 'bold')).grid(row=0, column=5,
                                                                                                      sticky=W)
# Frame5 Interface
