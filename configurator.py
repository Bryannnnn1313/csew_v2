...
v214 = Vuln("XXX", "", "Has the update check period been set to daily? (apt/apt.conf.d/10periodic)",
            False)
v215 = Vuln("updateAutoInstall", "", "Automatically download and install security updates.", False)
...
v315 = Vuln("XXX", "(Keywords)", "Check /etc/hosts for a specific string (Can take multiple entries)", False)
